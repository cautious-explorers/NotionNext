...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Simon Yang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不爱写代码的👨‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://myblog.simonyang.top/', // 网站地址
